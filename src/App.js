...
import Sample0 from './pages/sample0/classes/Sample0';
import Sample0_H from './pages/sample0/hooks/Sample0';
                    ...
                    <div className="app">
                        ...
                        <div className="menu">
                            ...
                            <div className="sub-menu">
                                ...
                                <Link to="/sample0_h">Sample 0</Link>
                        ...
                        <div className="main">
                            <Switch>
                                ...
                                <Route path="/sample0_h" component={Sample0_H} />
